...
var typed = new Typed(".typing", {
    strings: ["A Full Stack Developer", "A Car Enthusiast", "A Traveller", "A JAVA Backend Developer","A BIKE Lover"],
    typeSpeed: 120,
    backSpeed: 80,
    loop: true,
})
...
document.querySelector('#resume-link-1').addEventListener("click", () => {
    ...
    window.location.assign("https://drive.google.com/file/d/1zMZnC6KvRWcSIHJJddi1pns5Dazo009Q/view?usp=sharing", "_blank");
})
